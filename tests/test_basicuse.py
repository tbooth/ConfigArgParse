...
class TestBasicUseCases(TestCase):
    ...
    def testBasicCase2(self, use_groups=False):
        ...
        with self.tmpFile(suffix="_conf1") as default_config_file, \
             self.tmpFile(suffix="_conf2") as config_file2:
    ...
    def testSubParsers(self):
        with self.tmpFile(suffix="_conf1") as config_file1, \
             self.tmpFile(suffix="_conf2") as config_file2:
    ...
    def testEnvWithCombinedShortArgs(self):
        ...
        self.add_arg("-x", "--arg_x", action="store_true", default=False, env_var="ARG_X")
        self.add_arg("-y", "--arg_y", action="store_true", default=False, env_var="ARG_Y")
